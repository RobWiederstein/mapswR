...
```{r}
#| label: tbl-brewer-results
#| tbl-cap: Results from Brewer and Pickle [-@brewer_evaluation_2002]. Description edited for brevity.
#| echo: False
readr::read_csv(file = "../data/binning_methods_brewer.csv") %>% 
    kableExtra::kbl()
```
...
```{r}
#| label: fig-2019-us-life-exp-by-bounty
#| echo: false
#| fig-height: 4
#| fig-cap: "2019 U.S. Life Expectancy by County."
...
df %>%
    ...
    theme_half_open() +
    scale_x_continuous(limits = c(62, 95),
                       breaks = seq(62, 92, by=5),
...
```{r}
#| label: fig-life-exp-quantiles
#| echo: false
#| fig-height: 3
#| out-width: "100%"
#| fig-cap: "2019 U.S. Life Expectancy with quantiles style."
...
```{r}
#| label: fig-life-exp-equal
#| echo: false
#| fig-height: 3
#| out-width: "100%"
#| fig-cap: "2019 U.S. Life Expectancy with equal style."
map_life_expectancy(cut_method = "equal")
```
...
```{r}
#| label: fig-life-exp-pretty
#| echo: false
#| fig-height: 3
#| out-width: "100%"
#| fig-cap: "2019 U.S. Life Expectancy with pretty style."
map_life_expectancy(cut_method = "pretty")
```
...
```{r}
#| label: fig-life-exp-fisher
#| echo: false
#| fig-height: 3
#| out-width: "100%"
#| fig-cap: "2019 U.S. Life Expectancy with Fisher style."
map_life_expectancy(cut_method = "fisher")
```
...
```{r}
#| label: fig-life-exp-headtails
#| echo: false
#| fig-height: 3
#| out-width: "100%"
#| fig-cap: "2019 U.S. Life Expectancy with Headtails style."
map_life_expectancy(cut_method = "headtails")
```
...
```{r}
#| label: fig-life-exp-box
#| echo: false
#| fig-height: 3
#| out-width: "100%"
#| fig-cap: "2019 U.S. Life Expectancy with Box style."
map_life_expectancy(cut_method = "box")
```
